    ...
    <div>
      ...
      {showActions && (
        <Fragment>
          ...
          {/* auth.loading is a post user, auth.user._id is the logged in user. */}
...
const mapStateToProps = state => ({
  auth: state.auth, // because the delete button shows up only on users where the post belongs to them.
});
